...
"""autogenerated by genpy from audio_file_player/AudioFilePlayAction.msg. Do not edit."""
import codecs
import sys
...
import audio_file_player.msg
import genpy
import std_msgs.msg

class AudioFilePlayAction(genpy.Message):
  _md5sum = "125a6896e099ba136cd7140a77b672d0"
  _type = "audio_file_player/AudioFilePlayAction"
...
"""
  ...
  _slot_types = ['audio_file_player/AudioFilePlayActionGoal','audio_file_player/AudioFilePlayActionResult','audio_file_player/AudioFilePlayActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(AudioFilePlayAction, self).__init__(*args, **kwds)
      # message fields cannot be None, assign default values for those that are
      if self.action_goal is None:
        self.action_goal = audio_file_player.msg.AudioFilePlayActionGoal()
      if self.action_result is None:
        self.action_result = audio_file_player.msg.AudioFilePlayActionResult()
      if self.action_feedback is None:
        self.action_feedback = audio_file_player.msg.AudioFilePlayActionFeedback()
    else:
      self.action_goal = audio_file_player.msg.AudioFilePlayActionGoal()
      self.action_result = audio_file_player.msg.AudioFilePlayActionResult()
      self.action_feedback = audio_file_player.msg.AudioFilePlayActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_5I().pack(_x.action_result.result.total_time.secs, _x.action_result.result.total_time.nsecs, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs))
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2I().pack(_x.action_feedback.feedback.elapsed_played_time.secs, _x.action_feedback.feedback.elapsed_played_time.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.filepath = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.action_result.result.reason = str[start:end].decode('utf-8', 'rosmsg')
      else:
        self.action_result.result.reason = str[start:end]
      _x = self
      start = end
      end += 20
      (_x.action_result.result.total_time.secs, _x.action_result.result.total_time.nsecs, _x.action_feedback.header.seq, _x.action_feedback.header.stamp.secs, _x.action_feedback.header.stamp.nsecs,) = _get_struct_5I().unpack(str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      start = end
      ...
      (_x.action_feedback.feedback.elapsed_played_time.secs, _x.action_feedback.feedback.elapsed_played_time.nsecs,) = _get_struct_2I().unpack(str[start:end])
      return self
