...
class AudioFilePlayActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new AudioFilePlayFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = AudioFilePlayFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new AudioFilePlayActionFeedback(null);
    ...
    data.feedback = AudioFilePlayFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new AudioFilePlayActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = AudioFilePlayFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new AudioFilePlayFeedback()
    }
...
module.exports = AudioFilePlayActionFeedback;
